...
namespace Engine
{
	...
	enum RENDERID { RENDER_PRIORITY, RENDER_NONALPHA, RENDER_ALPHA, RENDER_UI, RENDER_FLOOR, RENDER_TILE, RENDER_END };
	...
	enum LOADINGID { LOADING_STAGE, LOADING_BOSS, LOADING_TEST, LOADING_KNUCKLEBONE, LOADING_DUNGEON, LOADING_END };
