...
_uint CLoadingThread::Loading_ForDungeon()
{
    ...
    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_GrassTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Grass/Grass%d.png", 21));
    ...
    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_RockTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Rock/Rock%d.png", 44));

    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_TreeTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Tree/Tree%d.png", 10));

    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_FireTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Fire/Fire%d.png", 2));

    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_TentTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Tent/Tent%d.png", 4));

    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_StairsTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Stairs/Stairs%d.png", 3));

    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_StoneTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Stone/Stone%d.png", 15));

    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_CandleTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Candle/Candle%d.png", 10));

    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_GatewayTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Gateway/Gateway%d.png", 6));
    
    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_SkullTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/Skull/Skull%d.png", 8));

    CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_TutorialObjectTexture",
        Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL,
            L"../Bin/Resource/Maps/Texture/Object/TutorialObject/TutorialObject%d.png", 6));
