...
void CLogo::Render_Scene()
{
	...
	switch (m_eLogoState) {
	case LS_START:
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"�÷���", &vPlay, D3DXCOLOR(1.f, 1.f, 1.f, 1.f), DT_CENTER | DT_NOCLIP);
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"������ ���", &vEdit, D3DXCOLOR(0.f, 0.f, 0.f, 1.f), DT_CENTER | DT_NOCLIP);
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"����", &vExit, D3DXCOLOR(0.f, 0.f, 0.f, 1.f), DT_CENTER | DT_NOCLIP);
		break;
	case LS_EDIT:
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"�÷���", &vPlay, D3DXCOLOR(0.f, 0.f, 0.f, 1.f), DT_CENTER | DT_NOCLIP);
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"������ ���", &vEdit, D3DXCOLOR(1.f, 1.f, 1.f, 1.f), DT_CENTER | DT_NOCLIP);
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"����", &vExit, D3DXCOLOR(0.f, 0.f, 0.f, 1.f), DT_CENTER | DT_NOCLIP);
		break;
	case LS_EXIT:
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"�÷���", &vPlay, D3DXCOLOR(0.f, 0.f, 0.f, 1.f), DT_CENTER | DT_NOCLIP);
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"������ ���", &vEdit, D3DXCOLOR(0.f, 0.f, 0.f, 1.f), DT_CENTER | DT_NOCLIP);
		CFontMgr::GetInstance()->Render_Font(L"Font_Lapture40", L"����", &vExit, D3DXCOLOR(1.f, 1.f, 1.f, 1.f), DT_CENTER | DT_NOCLIP);
		break;
	}
}
