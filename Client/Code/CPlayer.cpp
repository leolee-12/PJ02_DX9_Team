...
#pragma region ��������Ʈ ���� ���� - ���ؽ�/�ε��� ���� �̻��
	...
	// ������ ���ؽ� ���۸� �������� �����ϸ� ������� ����
	// - ���ؽ�/�ε��� ���۸� ������� �ʰ� �׸��� : DrawPrimitiveUP
	// - �ε������� �����Ƿ� D3DPT_TRIANGLELIST ��� �Ұ� : D3DPT_TRIANGLESTRIP���� �׸��� (0-1-2), (2-1-3) ���� �׷���
	// 0 1 > 0 1
	// 3 2 > 2 3
...
void CPlayer::Set_Texture()
{
	...
	m_matTex._11 = 0.0625f;	// ���δ� 16ĭ ����
	m_matTex._22 = 0.0625f;	// ���δ� 16ĭ ����(Player)
