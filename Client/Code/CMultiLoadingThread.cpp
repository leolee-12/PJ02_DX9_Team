...
void CMultiLoadingThread::Loading_for_Village()
{
	...
	m_TexturLoadingqueue.push(TEXLR(L"Proto_BuildingIconBack", TEX_NORMAL, L"../Bin/Resource/LWY/UI/BuildingCraft/dds/BuildIconBack_Green.dds", 1));
	m_iTotalProtoCount++;
	// WYWYWY
...
void CMultiLoadingThread::Loading_for_RealDungeon()
{
	...
	m_TexturLoadingqueue.push(TEXLR(L"Proto_WeaponInfo", TEX_NORMAL, L"../Bin/Resource/YSH/UI/WeaponInfo%d.png", 2));
	m_iTotalProtoCount++;
