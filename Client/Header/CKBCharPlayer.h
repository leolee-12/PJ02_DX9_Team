...
class CKBCharPlayer : public CUi
{
public:
...
private:
	explicit CKBCharPlayer(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CKBCharPlayer();
...
public:
	...
	void				Set_FlipX(_bool bFlip) { m_bFlipX = bFlip; }
...
public:
	static CKBCharPlayer* Create(LPDIRECT3DDEVICE9 pGraphicDev, const _vec3& vPos);
