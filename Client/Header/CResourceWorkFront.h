...
{
private:
	explicit CResourceWorkFront(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CResourceWorkFront();
...
public:
	static CResourceWorkFront* Create(LPDIRECT3DDEVICE9 pGraphicDev, _vec3 _vPos);
