...
class CBishop_Shamura :
	public CGameObject
{
private:
	explicit CBishop_Shamura(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CBishop_Shamura();
...
public:
	static CBishop_Shamura* Create(LPDIRECT3DDEVICE9 pGraphicDev, IMessageChannel* pMessageChannel, const Engine::SPAWNDATA& tSpawndata);
