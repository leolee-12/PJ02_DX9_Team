...
{
private:
	explicit CBishop_Heket(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CBishop_Heket();
...
public:
	static CBishop_Heket* Create(LPDIRECT3DDEVICE9 pGraphicDev, IMessageChannel* pMessageChannel, const Engine::SPAWNDATA& tSpawndata);
